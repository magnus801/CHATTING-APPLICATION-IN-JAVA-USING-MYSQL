...
public class UserTwo implements ActionListener, Runnable {
    ...
    UserTwo() {
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/vitpune.png"));
        ...
        JLabel name = new JLabel("VIT PUNE");
        name.setBounds(110, 15, 100, 18);
        name.setForeground(Color.WHITE);
        name.setFont(new Font("SAN_SERIF", Font.BOLD, 18));
        p1.add(name);
        
        JLabel status = new JLabel("Atharva, Ghanashyam, Monis, Suryan");
